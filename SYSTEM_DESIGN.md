...
- **Plugin Syntax**: The `io.kestra.plugin.aws.sns.Publish` plugin specifically requires the `from` field to populate the SNS Subject line and the `data` field for the message content.
